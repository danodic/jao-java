...
public class JaoLayer {
    ...
    /**
     * Will execute the init events for this layer. It is invoked automatically
    ...
    /**
     * Set all parameters for the layer. Overwrites existing parameters.
     *
     * @param parameters
     */
    ...
    /**
     * Return a map with the name of the event and the event object.
     *
     * @return All events from this layer.
     */
     ...
     *
     * @return A instance of Event in case there is an event engaged, else it
     * will return null.
     */
    ...
    /**
     * Will set the current event to be executed by this layer. In case the
     * event cannot be found in the list of events, it will remain as null and
     * this layer will not do anything. That is also the behavior when a layer
     * is empty: it won`t do anything.
     *
    ...
    /**
     * Will render the current laer at the current event in the screen. Will not
     * do anything in case the current event is null.
     *
     * @param elapsed How much has elapsed since the beginning of the current
     * event execution.
     */
    public void render(long elapsed, Object... args) {
    ...
    /**
     * Get the current scale factor, so that the renderer can resize elements to
     * fit a reference resolution if necessary
     *
    ...
    /**
     * Will add an initializer to the list of initializers in this layer. Also,
     * will re-execute all initializers. It is recommended to add them all at
     * once with addInitializers() for better performance.
     *
    ...
    /**
     * Create a deep copy of this JaoLayer initialized (ignoring current state).
     *
     * @param jao The parent Jao instance.
     * @return A deep copy of JaoLayer.
     * @throws CannotInstantiateJaoRenderer In case the renderer cannot be
